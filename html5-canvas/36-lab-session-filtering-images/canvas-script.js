...
window.onload = function () {
  ...
  amsterdamImage.src = 'amsterdam.jpg' + '?' + new Date().getTime();
  ...
  amsterdamImage.onload = function () {
    ...
    // - createImageData() Creates a new, empty ImageData object
    // - getImageData() Returns an ImagaData object that copies the pixel data for the specified rectangle on a canvas
